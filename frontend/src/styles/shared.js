...
export const shared = StyleSheet.create({
  ...
  container: {
    // outermost view, provides top padding and centering margins
    paddingTop: 80,
  ...
  scrollView: {
    // scroll view specific style for background outside of view
    backgroundColor: colors.background,
  },
  body: {
  ...
  content: {
    // flex container for content using map()
    display: "flex",
    gap: 15,
    marginVertical: 15,
    alignItems: "left",
